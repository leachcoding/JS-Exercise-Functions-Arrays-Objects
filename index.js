...
console.log(addNumbers(1,2), "This is addNumbers test");
...
console.log(makePersonObject(1, 'bob', "bob@email.com"));
console.log(makePersonObject(2, "jerry", "jerry@email.com"));

let objectNew = { id: 2, name: "jerry2", email: "jerry2@email.com"};

console.log(objectNew.id, "This is objectNews id");
...
function getName(name) {
  /* code here */
  return `Hello, my name is ${name.name}, my id is ${name.id}, my email is ${name.email}`;
}

console.log(getName(objectNew));
...
console.log(makeSmartPerson("jimbob"));
console.log(makeSmartPerson().sum(1,2));
console.log(makeSmartPerson("jimbob").speak());
...
function getCarInfoById(inventory, id) {
  /* code here */
  return `This is a ${inventory[id - 1].car_make} ${inventory[id -1].car_model} ${inventory[id -1].id}`;
}
...
function getGermanCars(inventory) {
  ...
  for(let i = 0; i < inventory.length; i++) {
    if (inventory[i].car_make === 'Audi' || inventory[i].car_make === 'Mercedes-Benz' || inventory[i] === 'Volkswagen' || inventory[i] === 'BMW') {
      newArray.push(inventory[i]);
    }
  }
